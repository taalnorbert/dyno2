...
class _LapTimeScreenState extends State<LapTimeScreen> {
  ...
  final int _minPointsForCompletion =
      20; // Minimális pontszám a pálya befejezéséhez
  ...
  void _trackLocation() {
    _positionStreamSubscription = Geolocator.getPositionStream(
      ...
      if (_trackPoints.length > _minPointsForCompletion &&
          !_isStartPointChecked) {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: _isRecording
                      ? null
                      : () {
                          // Itt lehetne a pálya mentésének logikája
                        },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.blue,
                    padding: EdgeInsets.symmetric(
                        horizontal: 50, vertical: 15), // Wider padding
                  ),
                  child: Text(
                    "Mentés",
                    style: TextStyle(color: Colors.black),
